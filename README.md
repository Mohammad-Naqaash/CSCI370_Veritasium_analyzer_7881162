...
**Very Important**: When you download the this GitHub zip folder and you have extracted the files, make sure to choose the correct folder with all the python files and move it out into your main C:\ drive area, so you can not experience any issues in starting up. 
